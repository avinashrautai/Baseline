    ...
    return (
      <div className={cn("relative", className)}>
        ...
        <input
          ...
          value={value}
          className={cn(
            "w-full pl-10 pr-10 py-2.5 text-body text-foreground placeholder:text-muted/60 transition-all duration-150",
            "focus:outline-none",
            variant === "default" && [
            ...
            variant === "minimal" && [
              "rounded-lg bg-layer/50 border border-transparent",
              "focus:bg-surface focus:border-border",
            ]
          )}
          {...props}
        />
